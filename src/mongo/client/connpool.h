...
namespace mongo {
    ...
    */
    ...
    public:
        ...
        DBClientBase *get(const string& host, double socketTimeout = 0, const string& username=string(), const string& passwd=string());
        DBClientBase *get(const ConnectionString& host, double socketTimeout = 0, const string& username=string(), const string& passwd=string());
    ...
    */
    ...
    public:
        /** the main constructor you want to use
            ...
            */
        explicit ScopedDbConnection(const string& host, double socketTimeout = 0, const string& username=string(), const string& passwd=string()) : _host(host), _conn( pool.get(host, socketTimeout, username, passwd) ), _socketTimeout( socketTimeout ) {
            _setSocketTimeout();
        }

        explicit ScopedDbConnection(const ConnectionString& host, double socketTimeout = 0, const string& username=string(), const string& passwd=string()) : _host(host.toString()), _conn( pool.get(host, socketTimeout, username, passwd) ), _socketTimeout( socketTimeout ) {
            _setSocketTimeout();
        }
